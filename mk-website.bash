...
for FNAME in csv2json csv2mdtable csv2xlsx csvcols csvfind csvjoin csvrows finddir findfile jsoncols jsonjoin jsonmunge jsonrange mergepath range reldate timefmt urlparse vcard2json xlsx2csv xlsx2json sheets2csv; do
